<?php
	...
	fx_show_metabox(array('body' => array('function' => 'enum_form'), 'footer' => array('hidden' => true)));			
	...
	if (is_fx_error($explorer)) {
		...
		$add_enum_btn = "\n\t\t\t<div class=\"button green\" onclick=\"add_enum(".$_SESSION['current_schema'].")\">Add New Enum</div>\n";			 
